  ...
  definitions: {
    ...
    Exercise: {
      ...
      properties: {
        ...
        muscle_groups: {
          type: "object",
          properties: { primary: { type: "string" }, secondary: { "type": "array", items: { type: "string" } } }
        },
    ...
    WorkoutExerciseInput: {
      ...
      properties: {
        ...
        sets: { "type": "array", "items": { "$ref": "#/definitions/WorkoutSet" } }
      }
    },
    WorkoutInput: {
      type: "object",
      ...
      "properties": {
        ...
        "exercises": { "type": "array", "items": { "$ref": "#/definitions/WorkoutExerciseInput" } }
      }
    },
    ...
    WorkoutDetail: {
      ...
      "properties": {
        ...
        "exercises": { "type": "array", "items": { "$ref": "#/definitions/WorkoutExerciseDetail" } },
